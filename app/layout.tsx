...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    // Kullanıcıların asistanlara sorduğu hâliyle talep ifadeleri.
    'Kahramanmaraş mimarlık ofisi',
    'Kahramanmaraş villa yaptırmak',
    'Maraş villa mimarı',
    'Onikişubat mimarlık bürosu',
    'Elbistan mimar',
    'Pazarcık mimar',
    'Türkoğlu mimar',
    'mimari proje ücretleri Kahramanmaraş',
    'villa projesi çizdirmek',
  ],
